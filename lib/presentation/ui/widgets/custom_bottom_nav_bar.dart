              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color:
                            provider.selectedIndex == 0 ? Colors.white : null,
                        borderRadius: BorderRadius.circular(50)),
                    child: Image.asset(
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color:
                            provider.selectedIndex == 1 ? Colors.white : null,
                        borderRadius: BorderRadius.circular(50)),
                    child: Image.asset(
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color:
                            provider.selectedIndex == 2 ? Colors.white : null,
                        borderRadius: BorderRadius.circular(50)),
                    child: Image.asset(
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color:
                            provider.selectedIndex == 3 ? Colors.white : null,
                        borderRadius: BorderRadius.circular(50)),
                    child: Image.asset(
